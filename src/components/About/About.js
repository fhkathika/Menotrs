...
const About = () => {
    return (
        <div>
            <h1>about</h1>
         <div className="info">
         <div className="about"><p>About Us
Mentors’  is the most reputed educational institution and admission consulting house dedicated to prepare students in their admissions, standardized tests and academic studies. It’s a student-focused institution that offers a vibrant and inspirational learning environment.
